...
parts.append(
    ...
    "This line does not say whether that commit is current. When asked whether"
    " your guidance is up to date, report this line and compare it with the head"
    " of `main` in `bestdan/agent-guidance`; do not assume it is current." + refresh + "\n"
